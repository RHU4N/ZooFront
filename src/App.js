...
import UpdateAnimais from './components/Animais/UpdateAnimais';
...
import UpdateTrabalhadores from './components/Trabalhadores/UpdateTrabalhadores';
import './App.css';
    ...
    <div className="App">
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/updateAnimais/:id" element={<UpdateAnimais />} />
          ...
          <Route path='/updateTrabalhadores/:id' element={<UpdateTrabalhadores />} />
        </Routes>
      </BrowserRouter>
    </div>
  );
